...
namespace CircularQueues_CSharp
{
    class Queues
    {
        ...
        public void insert(int element)
        {
            ...
            /* The following statement checkks whether the queue is empty. If the queue is
            ...
            {
                /* If REAR is at the last position of the array, the array, then the value of REAR
        ...
        public void remove()
        {
            ...
            {
                /*If the element to be deleted is at the last position of the array, then the
                 * value of FRONT is set to 0 i.e to the first element of the array. */
                if (FRONT == max - 1)
                    FRONT = 0;
                else
